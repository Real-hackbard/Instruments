...
All electronic musical instruments can be viewed as a subset of [audio signal processing](https://en.wikipedia.org/wiki/Audio_signal_processing) applications. Simple electronic musical instruments are sometimes called [sound effects](https://en.wikipedia.org/wiki/Sound_effect); the border between sound effects and actual musical instruments is often unclear.

In the 21st century, electronic musical instruments are now widely used in most styles of music. In popular music styles such as electronic dance music, almost all of the instrument sounds used in recordings are electronic instruments (e.g., [bass synth](https://en.wikipedia.org/wiki/Keyboard_bass), [synthesizer](https://en.wikipedia.org/wiki/Synthesizer), [drum machine](https://en.wikipedia.org/wiki/Drum_machine)). Development of new electronic musical instruments, controllers, and synthesizers continues to be a highly active and interdisciplinary field of research. Specialized conferences, such as the International Conference on New Interfaces for Musical Expression, have organized to report cutting-edge work, as well as to provide a showcase for artists who perform or create music with new electronic music instruments, controllers, and synthesizers.
